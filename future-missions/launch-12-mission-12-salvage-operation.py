# Launch 12 - Mission 12 - Salvage Operation
...
NORMAL_SPEED = 150
ATTACHMENT_UP_POSITION = 37
TURN_SPEED = 150
FIRST_TURN_ANGLE = 84
SECOND_TURN_ANGLE = 172
...
async def main():
    ...
    # Move forward
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, 410, 0, velocity=NORMAL_SPEED)
    motor_pair.stop(motor_pair.PAIR_1)
