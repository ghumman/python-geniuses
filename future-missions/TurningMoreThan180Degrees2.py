...
async def main():
    ...
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, 750, 0, velocity=NORMAL_SPEED)
    ...
    for i in range(14):
        await left_turn(motor_pair.PAIR_1, 15)
        await right_turn(motor_pair.PAIR_1, -1)
